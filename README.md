...
|:--------------:|:---------------:|:-------------:|
| ![Track](https://share.serenity-hosting.com/img/f09815b4410f1c23.jpg) | ![Notify](https://share.serenity-hosting.com/img/37a61ffe09782324.png) |
...
1. **Download** the latest release
   ```bash
   git clone https://github.com/RagnarTheGreat/Fivem-Star-Chase
   ```
